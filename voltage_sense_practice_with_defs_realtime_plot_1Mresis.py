import sys
sys.path.append("/home/pi/python2lib/Adafruit-Raspberry-Pi-Python-Code-master/Adafruit_I2C")
sys.path.append("/home/pi/python2lib/Adafruit-Raspberry-Pi-Python-Code-master/Adafruit_ADS1x15")
...
run_length = float(10)/60 #time to collect data in hours
...
for i in range(0,int(number_points)):
    ...
    if __name__ == '__main__':
        ...
        #Plot the data
        ax1 = plt.subplot(241)
        plt.plot(Current100Mohm[:,10],Current100Mohm[:,2],'bo',markersize=8)
